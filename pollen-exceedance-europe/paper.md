...
Under 10,000 randomized first-appearance timelines, >95% of simulated sites showed at least one pastoral taxon appearing before Cerealia — simply because pastoral taxa are native species present since ~9,400 cal BP while Cerealia is introduced at ~7,500–5,800 cal BP depending on region. The observed proportion (97–100%) does not differ from this null prediction. **First-appearance ordering therefore carries no interpretive weight and cannot be used as evidence for or against any hypothesis about human activity.**

By contrast, the exceedance metric has no trivial null prediction at natural sites. At H3 sites, pastoral taxa are present (100%) but never exceed their baseline (0/37). This asymmetry — universal presence but zero exceedance at natural sites — validates the exceedance threshold as a genuine discriminator of anthropogenic influence.

All claims in this paper are based on exceedance, not first appearance. We explicitly state that the observation "pastoral taxa appear before Cerealia in pollen records" is a predictable consequence of native-versus-introduced biogeographic status and should not be cited as evidence for pastoral-first land use.

#### 3.5.1 Exceedance versus first-appearance agreement
...
A source-area model based on published pollen productivity estimates (PPEs; Broström et al., 2008) and relevant source area estimates (Sugita, 2007) provides a quantitative framework. Cerealia-type pollen, with a fall speed of ~0.06 m/s, has an effective source radius of approximately 100--300 m for small lakes, compared with 300--1,000 m for *Plantago lanceolata*. For a settlement located 1 km from a coring site, pastoral indicators from grazing areas would be detectable almost immediately, while cereal pollen would require field expansion to within ~300 m of the lake — a process estimated to take 300--1,600 years depending on agricultural expansion rates. The observed median pastoral-to-Cerealia lag of 3,076 years exceeds this source-area prediction by a factor of 2--10, indicating that while differential source area contributes to the observed ordering, it cannot fully account for it.
...
**Replication scope.** The exceedance ordering (67–82% pastoral-first) and intensification gradient replicate fully across all three regions with adequate sample sizes (all n > 50, all binomial p < 0.0001). However, the H1-versus-H3 exceedance comparison rests on adequate samples in two regions (British Isles n = 18 H3 sites, Scandinavia n = 15) but only four H3 sites in Central Europe. With n = 4, the Central European H3 comparison has no meaningful statistical power and should be regarded as exploratory rather than confirmatory. All Central European H1-versus-H3 comparisons reported in this paper are therefore illustrative; the evidential weight for the H3 contrast rests on the British Isles and Scandinavia. The combined meta-analysis is robust because it is dominated by these two adequately powered regions.

**Partial circularity.** Comparing pastoral BC% between H1 and H3 sites classified by pastoral exceedance status introduces a degree of circularity. We have mitigated this by (a) treating pastoral contribution as a continuous variable in the intensification tests, (b) using the independent temporal gradient as primary evidence, and (c) reporting exceedance ordering — which depends on *when* exceedance occurs, not its magnitude — as the central finding.

**Differential detection versus genuine sequence.** As discussed in Section 4.3, we cannot determine whether the exceedance ordering reflects genuine temporal priority of pastoral over arable land use or differential pollen-detection thresholds. We recommend interpreting the ordering as a pollen taphonomic sequence pending corroboration from non-palynological sources.

**Regional coverage.** The three study regions represent northwest and central Europe. Mediterranean, southeastern European, and eastern European contexts — where Neolithic transitions, forest composition, and climate dynamics differ substantially — are not represented and may not show the same patterns.

**The 16% pre-Neolithic detections.** The strict pastoral index eliminates these, identifying them as natural heathland, but their existence in the standard index underscores the importance of careful indicator selection.

**Chronological uncertainty.** Radiocarbon dating uncertainties of ±100–200 years at individual sites mean that exceedance ordering within individual sites is reliable only where offsets exceed several centuries. The 331 sites in our dataset vary substantially in chronological control quality — from well-dated cores with multiple AMS dates and Bayesian age-depth models to records with fewer dates and linear interpolation. We did not filter by chronological quality, as this would introduce selection bias toward well-studied sites concentrated in particular regions. However, the regional-scale statistical tests (binomial, LMM) aggregate across many sites and are robust to random site-level chronological noise, which adds variance but not systematic bias. The key offsets — Plantago preceding signal onset by 400–1,765 years, pastoral exceedance preceding arable exceedance by ~3,076 years — substantially exceed typical dating uncertainties. Nevertheless, the Cerealia offset in Central Europe (362 yr) approaches the chronological noise floor, and we urge caution in interpreting this regional value.

**Magnitude limitation.** Power analysis (5%) means that magnitude-based comparisons are uninformative. This is a data limitation, not a methodological flaw, but it constrains what can be concluded about the *amplitude* of anthropogenic versus natural vegetation change.
